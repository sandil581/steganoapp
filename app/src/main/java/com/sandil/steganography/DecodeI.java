...
public class DecodeI extends Activity {

        private static final String LOG_TAG = DecodeI.class.getSimpleName();
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_decode_i);
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            if (resultCode == RESULT_OK) {
                ...
                decodedView.setImageBitmap(EncodeI.decodeBitmapScaledDown(decodedView, selectedImagePath));
            }
        }
